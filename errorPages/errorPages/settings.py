...
SECRET_KEY = 'django-insecure-@y%gn9aosn_v=6f%-^r-qg0qles+l3pbar)7v0jc$xf%y50a#$'
...
#Definir que debe de hacer Django cuando ocurre un 404
HANDLER404='app.views.show_error_404'
#Definir que debe de hacer Django cuando ocurre un 500
